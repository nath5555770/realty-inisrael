...
(function () {
  ...
  const DICT = {
    en: {
      ...
      'Découvrir les 14 biens →': 'Discover all 14 properties →',
      '5 PIÈCES': '5 ROOMS',
    ...
    he: {
      ...
      "Le délai médian est de 52 jours entre le heskem zikaron (compromis) et le heskem mekher avec inscription au Tabu. Pour un acquéreur depuis la France, le parcours complet dure en moyenne 8 à 14 mois.": "משך הזמן החציוני הוא 52 ימים בין זיכרון הדברים (ההסכם המקדים) להסכם המכר ולרישום בטאבו. עבור רוכש מצרפת, התהליך כולו נמשך בממוצע 8 עד 14 חודשים.",
      "Travaillez-vous avec un notaire spécifique ?": "האם אתם עובדים עם נוטריון מסוים?",
      "Oui — Maître Eitan Cohen, notaire bilingue inscrit aux barreaux de Tel Aviv et Paris. Toutes les transactions de la maison passent par son cabinet. Vous lisez ce que vous signez.": "כן — איתן כהן, נוטריון דו-לשוני החבר בלשכות עורכי הדין בתל אביב ובפריז. כל עסקאות המשרד עוברות דרך משרדו. אתם קוראים את מה שאתם חותמים.",
      ...
      "Composez votre recherche.": "בנו את החיפוש שלכם.",
      "Bureaux": "משרדים",
      "Terrain": "מגרש",
      "Immeuble": "בניין",
      "Mrd ₪": "מיליארד ₪",
      ...
      'Découvrir les 14 biens →': '← גלו את 14 הנכסים',
      '5 PIÈCES': '5 חדרים',
    ...
    ru: {
      ...
      "Le carnet privé": "Частный дневник",
      ...
      "Acquisition · aliyah patrimoniale": "Покупка · алия (вложение капитала)",
      ...
      "Le délai médian est de 52 jours entre le heskem zikaron (compromis) et le heskem mekher avec inscription au Tabu. Pour un acquéreur depuis la France, le parcours complet dure en moyenne 8 à 14 mois.": "Медианный срок — 52 дня между предварительным договором (зихрон дварим) и договором купли-продажи (хескем мехер) с регистрацией в Табу. Для покупателя из Франции весь процесс занимает в среднем от 8 до 14 месяцев.",
      "Travaillez-vous avec un notaire spécifique ?": "Работаете ли вы с конкретным нотариусом?",
      "Oui — Maître Eitan Cohen, notaire bilingue inscrit aux barreaux de Tel Aviv et Paris. Toutes les transactions de la maison passent par son cabinet. Vous lisez ce que vous signez.": "Да — Эйтан Коэн, двуязычный нотариус, член коллегий адвокатов Тель-Авива и Парижа. Все сделки агентства проходят через его контору. Вы читаете то, что подписываете.",
      ...
      "Composez votre recherche.": "Настройте свой поиск.",
      "Bureaux": "Офисы",
      "Terrain": "Участок",
      "Immeuble": "Здание",
      "Mrd ₪": "млрд ₪",
      ...
      'Découvrir les 14 biens →': 'Открыть 14 объектов →',
      '5 PIÈCES': '5 КОМНАТ',
